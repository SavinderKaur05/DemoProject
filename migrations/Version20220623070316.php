 ...
 */
final class Version20220623070316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, class_id_id INT NOT NULL, admission_number VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_B723AF339D86650F (user_id_id), INDEX IDX_B723AF339993BF61 (class_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE student ADD CONSTRAINT FK_B723AF339D86650F FOREIGN KEY (user_id_id) REFERENCES users (id)');
